...
export default function Pill(props: any) {
 ...
 return (
  <Card className="w-[25rem] h-max bg-gradient-to-tr border-1 dark:border-gray-700 dark:from-black dark:to-gray-800 border-gray-900 from-teal-100 to-gray-100 ">
   <CardHeader>
