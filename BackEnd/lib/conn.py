...
def upravit_termin(session, id_terminu, newStartDatum=None, newKonecDatum=None, newUcebna=None, newMax_kapacita=None, newVyucuje_id=None, newJmeno=None, cislo_cviceni=None):
